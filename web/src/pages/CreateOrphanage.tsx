...
export default function CreateOrphanage() {
  ...
  const [open_on_weekends, setOpen_on_weekeds] = useState(true)
          ...
          <fieldset>
            ...
            <div className="input-block">
              ...
              <div className="button-select">
                <button type="button" className={open_on_weekends ? 'active' : ''} onClick={() => setOpen_on_weekeds(true)}>Sim</button>
                <button type="button" className={!open_on_weekends ? 'active' : ''} onClick={() => setOpen_on_weekeds(false)}>Não</button>
              </div>
            </div>
          </fieldset>
